            ...
            <div class="col-lg-10">
                <div class="card" style="border-radius: 20px;">
                    <div class="card-body p-4">
                        <h2 class="mb-4">
                            <i class="bi bi-plus-circle" style="color: #ff9a9e;"></i> Создать рецепт
                        </h2>
                        ...
                        <form action="{{ route('recipes.store') }}" method="POST" enctype="multipart/form-data" id="recipeForm">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('cooking_time') is-invalid @enderror" 
                                               id="cooking_time" name="cooking_time" value="{{ old('cooking_time') }}" min="1" required>
                                        @error('cooking_time')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('servings') is-invalid @enderror" 
                                               id="servings" name="servings" value="{{ old('servings') }}" min="1" required>
                                        @error('servings')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Введите ссылку на изображение</small>
                                        @error('image_url')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div id="ingredients-container">
                                <div class="ingredient-row mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" step="0.01" class="form-control" name="ingredients[0][quantity]" 
                            ...
                            <div id="steps-container">
                                <div class="step-row mb-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        <textarea class="form-control" name="steps[0][description]" rows="2" required></textarea>
                                        <button type="button" class="btn btn-danger btn-sm remove-step" disabled>
                                            <i class="bi bi-trash"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-pink">
                                    <i class="bi bi-check-circle"></i> Создать рецепт
                                </button>
